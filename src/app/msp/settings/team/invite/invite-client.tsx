...
import { ArrowLeft, UserPlus, Mail, Copy, ChevronDown, Trash2 } from "lucide-react";
...
export function InviteTeamMemberClient({ organization, pendingInvitations, currentUserRole, backUrl = "/msp/team" }: Props) {
